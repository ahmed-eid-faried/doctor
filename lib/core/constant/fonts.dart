...
//       TextStyle(fontSize: 16, color: AppColor.black, height: 1.8);
...
//   static const textStyle8 = TextStyle(color: AppColor.black);
...
class AppFontStyle {
  ...
  static const TextStyle black14w600smcp = TextStyle(
    color: Colors.black,
    fontSize: 14,
    fontWeight: FontWeight.w500,
