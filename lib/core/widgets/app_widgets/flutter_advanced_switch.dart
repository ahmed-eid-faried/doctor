...
class AdvancedSwitch extends StatefulWidget {
  const AdvancedSwitch({
    ...
    this.activeImage,
    this.inactiveImage,
    this.borderRadius = const BorderRadius.all(Radius.circular(AppSize.s16)),
    this.width = AppSize.s50,
    this.height = AppSize.s30,
    this.enabled = true,
...
class _AdvancedSwitchState extends State<AdvancedSwitch>
  ...
  void initState() {
    ...
    _animationController = AnimationController(
      vsync: this,
      duration: _duration,
      value: _controller.value ? AppSize.s1 : AppSize.s0,
    );
  ...
  Widget build(BuildContext context) {
    ...
    final containerSize = labelSize * AppSize.s2 + _thumbSize;
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: Opacity(
          opacity: widget.enabled ? AppSize.s1 : widget.disabledOpacity,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          width: _thumbSize - AppSize.s4,
                          height: _thumbSize - AppSize.s4,
                          child: widget.thumb ??
                              Container(
                                decoration: boxDecoration(
                                  color: const Color(0xFFFFFFFF),
                                  borderRadius: widget.borderRadius.subtract(
                                      BorderRadius.circular(AppSize.s1)),
                                  boxShadow: const [
                                    BoxShadow(
  ...
  void _initAnimation() {
    ...
    final offset = widget.width / AppSize.s2 - _thumbSize / AppSize.s2;
